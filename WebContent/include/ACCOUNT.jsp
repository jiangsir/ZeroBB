...
<c:forEach var="article" items="${articles}">
  ...
  <div class="article" style="height:auto">[${article.info}] <a href="http://${pageContext.request.localAddr}:${pageContext.request.localPort}${pageContext.servletContext.contextPath}/ShowArticle?id=${article.id}" target="_blank">${article.title}</a>
      <c:forEach var="upfile" items="${article.upfiles}"> <img src="images/paperclip.png" /> </c:forEach>
	   (${userBean.user.division})<br />
