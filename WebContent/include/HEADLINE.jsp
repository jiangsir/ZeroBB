...
<c:forEach var="article" items="${articles}" varStatus="varstatus">
	...
	<div style="text-align: center; font-size: 1.5em;"><a
		...
		target="_blank" style="${color}">${article.title}</a></div>
</c:forEach>
<div style="text-align:right"><a href="http://${pageContext.request.localAddr}:${pageContext.request.localPort}${pageContext.servletContext.contextPath}/?info=${info}&${pageContext.request.queryString}" target="_blank">更多...</a></div>
