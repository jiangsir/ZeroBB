...
<div style="text-align: right">
	<a
		href="http://${pageContext.request.localAddr}:${pageContext.request.localPort}${pageContext.servletContext.contextPath}/?info=${info}&${pageContext.request.queryString}"
		target="_blank">更多...</a>
</div>
