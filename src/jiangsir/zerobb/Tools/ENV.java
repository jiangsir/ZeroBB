...
public class ENV {
	...
	// public static Hashtable<String, Integer> IP_CONNECTION = new
	...
	private static Hashtable<String, Class<?>> Servlets = new Hashtable<String, Class<?>>();
	...
	public static void putServlet(Class<?> clazz) {
		ENV.Servlets.put(clazz.getAnnotation(WebServlet.class).urlPatterns()[0], clazz);
	}

	public static Hashtable<String, Class<?>> getServlets() {
		return ENV.Servlets;
	}
