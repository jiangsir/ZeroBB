...
public class GeneralFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
		...
		if (requestURI.matches(".*\\.[Cc][Ss][Ss]$") || requestURI.matches(".*\\.[Jj][Ss]$")
				|| requestURI.matches(".*\\.[Gg][Ii][Ff]$") || requestURI.matches(".*\\.[Pp][Nn][Gg]$")
				|| requestURI.matches(".*\\.[Hh][Tt][Mm]$") || requestURI.matches(".*\\.[Hh][Tt][Mm][Ll]$")
				|| requestURI.matches(".*\\.[Tt][Xx][Tt]$") || requestURI.matches(".*Include.*")
				|| requestURI.matches(".*Login$") || requestURI.matches(".*Logout$")
		...
		new LogDAO().insert(new Log(uri, session_account, request.getRemoteAddr(), "", null));
		...
		if ("GET".equals(request.getMethod()) && !requestURI.matches(".*\\..*")
				&& !requestURI.matches(".*SystemClosed.jsp$") && !requestURI.matches(".*ShowSessions$")
				&& !requestURI.matches(".*Download$") && !requestURI.matches(".*Logout.*")
